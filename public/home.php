        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-4">
                    <a href="./includes/auth/login.php" class="text-gray-600 hover:text-blue-600 px-4 py-2 rounded-lg transition duration-300 flex items-center">
                        <i class="fas fa-sign-in-alt mr-2"></i>
                        Login
                    </a>
                    <a href="./includes/auth/register.php" class="btn-add-transaction bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg transition duration-300 flex items-center">
    ...
    <div class="container mx-auto px-4 py-12 flex-grow">
        <div class="max-w-xl mx-auto bg-white shadow-2xl rounded-xl p-8 text-center">
            <div class="flex justify-end mb-4">
                <a href="./docs/unguide.pdf" download class="text-blue-600 hover:text-blue-800 flex items-center">
        ...
        <div class="bg-white rounded-lg p-8 max-w-md mx-4">
            ...
            <div class="bg-blue-50 p-4 rounded-lg mb-6">
                <div class="flex items-center justify-between">
                    ...
                    <a href="./docs/unguide.pdf" download class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-300 flex items-center">
            ...
            <div class="flex justify-end space-x-4">
                ...
                <a href="./includes/auth/register.php" class=" btn-add-transaction bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded transition duration-300">
                    Register Now
                </a>
            </div>
        </div>
